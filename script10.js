...
console.log(greetUser("Vandana", simpleGreetProvider));

console.log(greetUser("Vandana",timelyGreetProvider));

console.log(greetUser("Vandana", function() { return "Sasriakal ";}));

console.log(greetUser("Sindhu",()=>"Namasthey "));

console.log(greetUser("Sindhu",()=>"Vanakkam "));
console.log(greetUser("Sindhu",()=>"Namaskar "));
